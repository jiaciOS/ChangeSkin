...
import xyz.jiaci.changeskin.utils.Utils;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                try {
                    mLoadClassDynamic = classLoader.loadClass("xyz.jiaci.plugin1.Dynamic");
    ...
    public AssetManager getAssets() {
        if(mAssetManager == null) {
            e("DEMO3", "mAssetManager is null");
            return super.getAssets();
        }

        e("DEMO3", "mAssetManager is not null");
    ...
    public Resources getResources() {
        if(mResources == null) {
            e("DEMO3", "mResources is null");
            return super.getResources();
        }

        e("DEMO3", "mResources is not null");
        return mResources;
    }
    ...
    public Resources.Theme getTheme() {
        if(mTheme == null) {
            e("DEMO3", "Theme is null");
            return super.getTheme();
        }

        e("DEMO3", "Theme is not null");
        return mTheme;
    }
}
